% MichiganRoads data (based on the 2004 AAA map)

% - - - - - - - - - - - - - - - - - - - - - - - - - -

% "TRANSLATOR" RULE - any program access of this
% data should use connected rather than dist
...
up([ crystalFalls, copperHarbor, covington, escanaba, 
     houghton, ironMountain, ironwood, manistique,
     marinette, marquette, rapidRiver, saultSteMarie,
     seney, stIgnace ]).

% NOTE:  A city is in the:
